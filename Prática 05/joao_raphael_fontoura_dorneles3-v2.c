 ...
 *
 *             SOLUÇÃO MAIS SIMPLES COMPARADA COM A ANTERIOR, MAS AINDA PODE MELHORAR
 *
 */
...
int main(){
    ...
    if(sucesso) printf("O menor número vale %d e o maior número vale %d.", menorNum, maiorNum);
